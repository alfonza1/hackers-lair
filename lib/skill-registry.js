...
function listSkills(options = {}) {
  ...
  const records = [
    ...recordsFromFiles(personalSkillFiles(personalSkills), () => ({
      kind: 'personal',
      origin: 'Workspace',
      skillsRoot: personalSkills,
    })).map((record) => ({ ...record, skillsRoot: personalSkills })),
...
module.exports = { listSkills, readSkillFile, skillRoots };
