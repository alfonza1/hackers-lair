...
const CHANNEL_DETAILS = Object.freeze({
  ...
  'linux-deb': {
    ...
    upgradeCommand: 'curl -fLO https://github.com/alfonza1/hackers-lair/releases/latest/download/hackers-lair_amd64.deb && sudo apt install ./hackers-lair_amd64.deb',
  },
  'linux-rpm': {
    label: 'Fedora/RHEL package',
    upgradeCommand: 'curl -fLO https://github.com/alfonza1/hackers-lair/releases/latest/download/hackers-lair_x86_64.rpm && sudo rpm -U ./hackers-lair_x86_64.rpm',
  },
  'linux-portable': {
    label: 'Linux portable archive',
    upgradeCommand: 'curl -fLO https://github.com/alfonza1/hackers-lair/releases/latest/download/hackers-lair-linux-x64.tar.gz && mkdir -p "$HOME/.local/opt/hackers-lair" && tar -xzf hackers-lair-linux-x64.tar.gz -C "$HOME/.local/opt/hackers-lair" --strip-components=1',
  },
  portable: {
