const THEMES = Object.freeze(['phosphor', 'ultraviolet', 'ice', 'volt', 'ghost']);
...
function normalizeUiPreferences(value = {}) {
  ...
  const theme = LEGACY_THEME_ALIASES[candidate.theme] || candidate.theme;
  return {
    theme: THEMES.includes(theme) ? theme : DEFAULT_UI_PREFERENCES.theme,
